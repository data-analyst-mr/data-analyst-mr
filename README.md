...
На текущий момент в перечень профессиональных обязанностей среди прочих входит работа с большим объемом данных, в том числе подготовка отчетов для ответственных служб. В целях развития данного навыка с 2021 года изучаю аналитику данных, тогда же решил пойти дальше и погрузиться в Data-Science, для чего прошел соответствующие курсы на платформе Яндекс Практикум.<br>
Поскольку на текущем месте система работы с данными выстраивалась в 2007-2009 годах, она не подразумевает использования машинного обучения. В связи с этим решил сменить место работы и реализовать полученные навыки в интересующей меня сфере - машинном обучении.
